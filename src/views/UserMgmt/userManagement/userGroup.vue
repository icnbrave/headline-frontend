  ...
  <div>
    <div class="app-container" calendar-list-container>
      ...
      <div v-show="showGrid == true">
        ...
        <grid-list :editable="true" :deletable="true" :tableData="userGroupList" :params="userGroupListParam" style="margin-top: 15px" @listenToDeleteEvent="userGroupDeleteEvent" @listenToEditEvent="userGroupEditEvent"></grid-list>
...
<script>
  ...
  import {getUserGroupList, getTreeData, getUserGroupDetail} from '@/views/UserMgmt/userManagement/apis'
  export default {
    name: 'HelloWorld',
    data () {
      return {
